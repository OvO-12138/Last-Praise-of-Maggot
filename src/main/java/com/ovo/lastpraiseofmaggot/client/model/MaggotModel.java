package com.ovo.lastpraiseofmaggot.client.model;
...
public class MaggotModel extends HierarchicalModel<MaggotEntity> {

    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
            new ResourceLocation(LastPraiseOfMaggot.MODID, "brother_maggot"),
            "main"
    );
